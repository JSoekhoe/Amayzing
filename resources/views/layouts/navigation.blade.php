<nav x-data="{ open: false }" class="bg-white border-b border-gray-200 font-light">
    <div class="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        <div class="flex justify-between items-center h-20">
            ...
            {{-- Hamburger menu (links op mobiel) --}}
            ...
            {{-- Logo (centraal op mobiel) --}}
            <div class="absolute left-1/2 transform -translate-x-1/2 md:static md:transform-none md:flex md:items-center">
            <a href="{{ route('home') }}" class="text-2xl font-semibold font-serif text-gray-800 tracking-tight">
                    aMayzing
                </a>
            </div>

            {{-- Login / Dashboard (rechts op mobiel) --}}
            <div class="md:hidden flex items-center space-x-4 text-sm">
                @guest
            ...
            {{-- Desktop menu (verberg op mobiel) --}}
            <div class="hidden md:flex space-x-6 items-center text-base text-gray-700">
